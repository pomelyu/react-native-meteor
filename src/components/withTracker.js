...
export default function withTracker(mapMeteorDataToProps) {
  return function (WrappedComponent) {
    class componetWithTracker extends React.Component {
      constructor(props) {
        super(props);
    ...
    componetWithTracker.displayName = `WithTracker(${newDisplayName})`;

    return componetWithTracker;
  }
}
